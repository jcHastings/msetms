...
- **Mike** on the dispatch board (not the driver app): side chat for ops questions from TMS data. Needs `OPENAI_API_KEY`. Never invents GPS. Never logs the key or PINs.
